...
const salaryRangesList = [
  ...
  {salaryRangeId: '1660000', label: '18 LPA and above'},
  {salaryRangeId: '2000000', label: '20 LPA and above'},
  {salaryRangeId: '3000990', label: '30 LPA and above'},
  {salaryRangeId: '4000000', label: '48 LPA and above'},
]
...
class AllJobs extends Component {
  ...
  onGetInputOption = event => {
    ...
    if (inputNotInList.length === checkboxInputs.length) {
      this.setState(
        prevState => ({
